...
@Component({
  selector: 'app-citywiseshowrreports',
  templateUrl: './citywiseshowrreports.component.html',
  styleUrls: ['./citywiseshowrreports.component.css'],
})
export class CitywiseshowrreportsComponent implements OnInit {
  dataList1: any[] = [];
  ...
  DownloadExcelFile(): void {
    ...
    if (this.bookingsexcel.length > 0) {
      for (let i = 0; i < this.bookingsexcel.length; i++) {
        ...
        //   obj1['Start Time'] = this.datePipe.transform(this.getTimeIn12Hour(this.bookingsexcel[i]['START_TIME']),'hh:mm a');
        //   obj1['End Time'] = this.datePipe.transform(this.getTimeIn12Hour(this.bookingsexcel[i]['END_TIME']),"hh:mm a");
        // }
